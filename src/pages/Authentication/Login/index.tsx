    ...
    <div className="flex-1 space-y-4 px-10 py-8 md:px-0 lg:px-20">
      ...
      <div className="mt-4 flex flex-col justify-between space-y-4 space-x-4">
        ...
        <div className="flex w-full justify-between">
          <Button
            variant={'outline'}
            className="border-mountain-950 dark:border-mountain-700 text-mountain-950 dark:text-mountain-50 flex h-10 w-[32%] items-center justify-center rounded-lg border px-4 py-3 text-sm font-normal hover:cursor-pointer hover:brightness-115"
