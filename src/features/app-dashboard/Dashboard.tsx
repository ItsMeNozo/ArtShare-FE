...
const Dashboard = () => {
  return (
    <div
      className="flex flex-col space-y-4 p-4 h-screen overflow-x-hidden sidebar"
      ...
      <div className="relative flex items-center p-4 rounded-xl w-full h-96">
        ...
        <div className="z-10 flex flex-col flex-1 space-y-8">
          ...
          <div className="flex space-x-4">
            <Link
              to="updates"
              className="flex justify-center items-center space-x-2 bg-mountain-950 hover:brightness-105 p-4 rounded-xl w-40 text-white hover:scale-105 transition duration-300 ease-in-out hover:cursor-pointer"
            >
              <p className="font-bold select-none">Version 1.52</p>
            </Link>
            <Link
              to="updates"
              className="flex justify-center items-center space-x-2 bg-gradient-to-r from-indigo-100 to-purple-50 hover:brightness-105 p-4 border border-mountain-200 rounded-xl w-40 text-mountain-950 hover:scale-105 transition duration-300 ease-in-out hover:cursor-pointer"
            >
              <IoNewspaperOutline />
