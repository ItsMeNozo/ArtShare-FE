    ...
    <div className="flex h-[calc(100vh-4rem)] w-full flex-col items-center gap-4 p-4">
      <div className="flex h-full w-full gap-4">
        ...
        <div className="border-mountain-200 flex h-full w-1/4 flex-col gap-2 space-y-2 rounded-3xl border bg-white">
          <div className="border-mountain-200 flex h-20 w-full items-center border-b-1 p-2">
            <div
              ...
              className="border-mountain-200 flex h-full w-full transform cursor-pointer items-center justify-center gap-2 rounded-xl border bg-gradient-to-r from-blue-600 to-purple-600 p-2 text-white hover:brightness-105"
            >
              <Plus />
        ...
        <div className="border-mountain-200 flex h-full w-3/4 flex-col overflow-y-auto rounded-3xl border bg-white">
          ...
          <div className="sidebar flex h-full w-full flex-col items-center space-y-4 p-4 pr-2">
            {isLoading ? (
              ...
              <>
                ...
                {facebookPages.length === 0 ? (
                  ...
                  facebookPages.map((page) => (
                    <div
                      key={page.id}
                      className="relative flex w-full items-center space-x-2 rounded-xl border border-gray-200 px-4 py-2 shadow-md"
                    >
                          ...
                          {page.autoProjects?.length > 0 ? (
                            page.autoProjects.map((project) => (
                              <Link
                                ...
                                className="shrink-0 rounded-full bg-indigo-100 px-2.5 py-1 text-sm text-indigo-700 transition-colors hover:bg-indigo-200"
                              >
                                {project.title}
                              </Link>
                            ))
